        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
                <form method="POST" action="{{ route('user.mydocuments.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="file-1" class="block text-sm font-medium text-gray-700 mb-2">Upload Abstrak</label>
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                    ...
                    <div class="mb-4">
                        <label for="file-bab-5" class="block text-sm font-medium text-gray-700 mb-2">Upload BAB 5</label>
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                            <input type="file" id="file-bab-5" name="bab5" accept="application/pdf" 
                                class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
                            <div class="flex items-center justify-center">
                                <svg class="w-8 h-8 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                                <span class="text-gray-600" id="preview-bab-5">Pilih file PDF</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4"> 
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload artikel join</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload lembar pengesahan skripsi</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        {{-- persyaratn 2--}}
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload lembar persetujuan skripsi</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload surat pernyataan jurnal </label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload surst pernyataan karya sendiri (skripsi)</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload Lembar Bimbingan</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                                <input type="file" id="file-7" name="persyaratan_2[]" accept="application/pdf" 
                                    class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
                                <div class="flex items-center justify-center">
                                    <svg class="w-8 h-8 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload SK Pembingbing </label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
