            ...
            <div>
                ...
                <form class="w-full" action="{{ route('dashboard.documents.store') }}" method="POST"
                    ...
                    @csrf <!-- CSRF Protection -->
                       ...
                       <input type="hidden" name="category" value="magang">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        {{-- <div class="mb-4">
                            <label for="persyaratan" class="block text-sm font-medium text-gray-700 mb-2">Scan Persyaratan</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                                <input type="file" name="persyaratan[]" id="persyaratan" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required multiple>
                                <div class="flex items-center justify-center">
                                    ...
                                    <span class="text-gray-600" id="">Pilih file PDF</span>
                                </div>
                            </div>
                        </div>
                    
                        <div class="mb-4">
                            <label for="persyaratan" class="block text-sm font-medium text-gray-700 mb-2">Scan Persetujuan</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                                <input type="file" name="persyaratan[]" id="persetujuan" accept="application/pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required multiple>
                                <div class="flex items-center justify-center">
                                    <svg class="w-8 h-8 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                    </svg>
                    ...
                    <div class="mb-4">
                        <label for="file" class="block text-sm font-medium text-gray-700 mb-2">Sertifikat selesai program</label>
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                    ...
                    <div class="mb-4">
                        <label for="file-1" class="block text-sm font-medium text-gray-700 mb-2">Upload Surat Rekomendasi
                        </label>
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                    ...
                    <div class="space-y-4">
                        <div class="mb-4">
                            <label for="file-1" class="block text-sm font-medium text-gray-700 mb-2">Upload Surat Keterangan di terima MBKM/Magang dari perusahaan</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload Log Book
                            </label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">C.04 Lembar Pendaftaran</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                                <input type="file" id="file-20" name="persyaratan_2[]" accept="application/pdf" 
                                    class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" required>
                                <div class="flex items-center justify-center">
                                    <svg class="w-8 h-8 text-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload Transkrip nilai dari instansi mbkm/magang                            </label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload PPT</label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
                        ...
                        <div class="mb-4">
                            <label for="file-3" class="block text-sm font-medium text-gray-700 mb-2">Upload Transkrip konversi dari jurusan
                            </label>
                            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-indigo-500 transition duration-200">
